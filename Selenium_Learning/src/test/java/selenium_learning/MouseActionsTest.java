...
public class MouseActionsTest {
	...
	public void clickTest() {
		...
		WebElement buttonDiv = wait.until(ExpectedConditions.visibilityOfElementLocated(
...
//				"window.scrollTo(0, document.body.scrollHeight / 3)");
		...
		WebElement clickButton = buttonDiv.findElement(By.xpath("//button[text()='Click Me']"));
		
		new Actions(driver).click(clickButton).perform();
	...
	public void doubleClickTest() {
		...
		WebElement clickButton = buttonDiv.findElement(By.id("doubleClickBtn"));
		
		new Actions(driver).doubleClick(clickButton).perform();
	...
	public void righClickTest() {
		...
		WebElement clickButton = buttonDiv.findElement(By.id("rightClickBtn"));
		
		new Actions(driver).contextClick(clickButton).perform();
